...
final class EpisodePushAnimator: SlidePushAnimator {
    ...
    override init() {
        ...
        beforeAnimate = { transitionContext in
            ...
            if let fromCell = fromVC.selectedCell, let fromImgView = fromCell.photoImageView,
               let toImgView = toVC.photoImageView {
                ...
                let transitionImageViewFrame = CGRect(
                    x: fromImgViewFrame.minX + fromView.frame.minX,
...
final class EpisodePopAnimator: SlidePopAnimator {
    ...
    override init() {
        ...
        beforeAnimate = { transitionContext in
            ...
            if let fromImgView = fromVC.photoImageView, let toCell = toVC.selectedCell,
               let toImgView = toCell.photoImageView {
                fromImageView = fromImgView
                toImageView = toImgView
                fromImgView.alpha = 0
                toImgView.alpha = 0
